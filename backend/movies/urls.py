...
from .views import DirectorViewSet, AnimeViewSet, BookViewSet, OrderViewSet  # นำเข้า ViewSets ทั้งหมดที่เราสร้างไว้จากไฟล์ views.py
...
router.register('animes', AnimeViewSet)  # ลงทะเบียนเส้นทาง /animes/ ผูกเข้ากับ AnimeViewSet
router.register('books', BookViewSet)  # ลงทะเบียนเส้นทาง /books/ ผูกเข้ากับ BookViewSet
